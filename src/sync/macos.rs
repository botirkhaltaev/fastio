...
impl File {
    ...
    ///
    /// On macOS, this uses `pread` and does not affect the current cursor position.
    ...
    /// # Platform-specific behavior
    ///
    /// On macOS, this uses `pwrite` and does not affect the current cursor position.
    #[inline]
    ...
    /// # Platform-specific behavior
    ///
    /// On macOS, this uses `pwrite` for each write and does not affect the current cursor
    /// position.
...
/// Options for opening a synchronous macOS file.
///
